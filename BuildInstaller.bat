...
python.exe Installer\tools\scripts\insert_files_commands_into_nsi_script.py Installer\included_files Installer\src\scrupdate_installer.nsi || (call :clean_all & goto :display_failure_message)
python.exe Installer\tools\scripts\insert_files_commands_into_nsi_script.py Installer\included_files Installer\src\scrupdate_system_auto_installer.nsi || (call :clean_all & goto :display_failure_message)
python.exe Installer\tools\scripts\insert_files_commands_into_nsi_script.py Installer\included_files Installer\src\scrupdate_user_auto_installer.nsi || (call :clean_all & goto :display_failure_message)
